        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div class="form-group">
              ...
              <select name="soal_jenis" class="form-control" required>
                <?php
                        $squeryjenissoal = "SELECT * FROM m_kategori";
                        $result = mysqli_query($db, $squeryjenissoal);
                        while ($rowjenissoal = mysqli_fetch_assoc($resultjenissoal)) {
                          ?>
                          <option value="<?php echo $rowjenissoal['kategori_id'];?>"><?php echo $rowjenissoal['kategori_nama'];?></option>  
                            <?php
                        }
                ?>
              </select>
